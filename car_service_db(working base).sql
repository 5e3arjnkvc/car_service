...
CREATE TABLE `appointments` (
  ...
  CONSTRAINT `appointments_ibfk_3` FOREIGN KEY (`service_id`) REFERENCES `service` (`id`)
...
--
-- Dumping routines for database 'car_service_db'
--
...
-- Dump completed on 2023-07-17 22:58:14
